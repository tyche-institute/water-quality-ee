...
The original motivation was an internal reflection note (`reflect/2026-04-15_health-data-gaps.md`) which identified two such divergences and hypothesised five possible explanations. This audit generalises from those two anchors to the whole dataset.
...
- Original motivation: internal reflection note (`reflect/2026-04-15_health-data-gaps.md`)
